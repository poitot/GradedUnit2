...
namespace ACEDrivingSchool2
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            var apiKey = "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";
            var client = new SendGridClient(apiKey);
            var myMessage = new SendGridMessage();
            var to = new EmailAddress(
                                message.Destination, "ACE driving school");
            myMessage.From = new EmailAddress(
                                "noreply@acedrivingschool.com", "ACE Driving School");
